...
def determine_number(birthdate)
...
##### call method
number = determine_number(birthdate)### 2:09pm created a new variable "number" and assigned the value of the method to it

##### determine message
def determine_message(number)
  case number
...
puts number
message = determine_message(number)
